let musicDB = [
    {
        id: 0,
        name: "Vannarapettailla",
        author_name: "Sivakarthikeyan",
        img: "vanarala.jpeg",
        lang: "tamil",
        timesPlayed: 0,
        type: "electronic",
        musicName: "Vannarapettayila - Lyrical Video _ Maaveeran _ Sivakarthikeyan_ Aditi Shankar _ Bharath Sankar(MP3_70K).mp3",
        attribution: {
            song: "Vannarapettayila - Lyrical Video _ Maaveeran _ Sivakarthikeyan_ Aditi Shankar _ Bharath Sankar(MP3_70K).mp3",
    ...
    },
    {
        ...
        timesPlayed: 0,
        type:"instrumental",
        musicName: "LEO - Naa Ready Lyric Video _ Thalapathy Vijay _ Lokesh Kanagaraj _ Anirudh Ravichander(MP3_160K).mp3",
        attribution: {
            song: "LEO - Naa Ready Lyric Video _ Thalapathy Vijay _ Lokesh Kanagaraj _ Anirudh Ravichander(MP3_160K).mp3",
            musicBy: "mixkit",
            download: null,
            stream: null
        }
    },
    {
        ...
        type: "electronic",
        timesPlayed: 0,
        musicName: "En Rojaa Neeye _ Kushi _ Vijay Deverakonda_ Samantha Ruth Prabhu _ Hesham Abdul Wahab _ Lyrical(MP3_160K).mp3",
        attribution: {
            song: "En Rojaa Neeye _ Kushi _ Vijay Deverakonda_ Samantha Ruth Prabhu _ Hesham Abdul Wahab _ Lyrical(MP3_160K).mp3",
            musicBy: "NoCopyrightSounds",
    ...
    },
    {
        ...
        timesPlayed: 0,
        type: "electronic",
        musicName: "Kesariya - Brahmāstra _ Ranbir Kapoor _ Alia Bhatt _ Pritam _ Arijit Singh _ Amitabh Bhattacharya(MP3_160K).mp3",
        attribution: {
            song: "Kesariya - Brahmāstra _ Ranbir Kapoor _ Alia Bhatt _ Pritam _ Arijit Singh _ Amitabh Bhattacharya(MP3_160K).mp3",
            musicBy: "NoCopyrightSounds",
    ...
    },
    {
        ...
        timesPlayed: 0,
        type:"instrumental",
        musicName: "Kaalathukkum Nee Venum Video Song _ VTK _ HDR_ Silambarasan TR _Gautham Vasudev Menon__ARRahman(MP3_160K).mp3",
        attribution: {
            song: "Kaalathukkum Nee Venum Video Song _ VTK _ HDR_ Silambarasan TR _Gautham Vasudev Menon__ARRahman(MP3_160K).mp3",
